...
and running cells visible. Every output cell can temporarily reveal its source;
keep at most one such code peek open and close the prior peek when another opens.
