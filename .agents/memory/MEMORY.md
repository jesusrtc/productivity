...
- [Terminal task summary gets its own multiline block](terminal-task-summary-is-multiline.md) — reserve three lines and clamp at four between connection state and terminal output
