...
- [Assistant uses the selected Compact design](assistant-project-first-document-modal.md) — one Tasks tab, compact original project groups and cards, and click-to-open modal; proposal comparison is complete
