...
rolling tmux sockets, groups them by vault/workspace, and separates sessions
that already have a Lab terminal tab from sessions available to add. Tmux's
live-client count is deliberately not used for this state. The workspace from
