...
async function main() {
  ...
  try {
    ...
    console.log(JSON.stringify({fixture,git,sidebar,terminals,timeOrigin,stats,misses,requestMisses,requestErrors,requestFailures,browserErrors,requests,rows},null,2));
