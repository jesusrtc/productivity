...
export async function installNavigationRefreshProbe(evaluate,workspaceRoot) {
  ...
  await evaluate(`(()=>{
    ...
    if(typeof history!=='undefined')for(const name of ['pushState','replaceState']) {
      history[name]=wrap('history.'+name,history[name]);
    }
