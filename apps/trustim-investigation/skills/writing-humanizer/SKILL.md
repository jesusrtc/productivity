...
description: >-
  Transforms and humanizes any piece of writing. Removes unnecessary words,
  avoids marketing cliches, and adopts a natural conversational tone. Use this
  skill when writing reports, conclusions, audit trail summaries, Slack
  messages, or any external-facing text.
allowed-tools: Bash
---

# Writing Humanizer

Your task is to transform and humanize any piece of writing, ensuring it is clear, direct, and engaging. The goal is to refine your source text by removing unnecessary words, avoiding marketing cliches, and adopting a natural, conversational tone. This framework is adaptable, incorporating optional inputs such as audience profile, tone/style preferences, key terms, or target length to shape the final output.
...
9. **Avoid AI-Giveaway Phrases**
   - Drop cliches like "dive into," "unleash your potential," etc.
...
14. **Remove Cliches, Jargon, Hashtags, Semicolons, Emojis, and Asterisks**
...
16. **Eliminate Redundancy and Repetition**
...
3. **Apply the Guidelines**
   ...
   - **Avoid Filler and Cliches**: Cut out phrases with no real content (e.g., "It's important to note...").
...
2. **Clarity**: No jargon, cliches, hashtags, emojis, or filler.
...
### Key Changes and Rationale (Optional):
...
- **Clarity and Conciseness**: Removed extra background details that weren't necessary.
