...
| Caller | PNG path |
|---|---|
| Investigation | `workspaces/<id>/assets/<slug>_ioc_over_time.png` |
| ASTA coverage | `workspaces/<id>/assets/<slug>_coverage_over_time.png` |
...
`workspaces/CLAUDE.md` in the monorepo for the recipe.
